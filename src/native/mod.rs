...
mod natives {
    ...
    extern "C" {
        pub fn saveShortcut(
            ...
            iconPath: *const winapi::ctypes::wchar_t,
        ) -> ::std::os::raw::c_int;
    ...
    fn create_shortcut_inner(
        ...
        let native_icon_path =
            U16CString::from_str(icon_path).log_expect("Error while converting to wchar_t");
